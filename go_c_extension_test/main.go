...
/*
This code was found from here: https://github.com/AlekSi/cgo-by-example/blob/master/main.go
The main purpose of this file is for us to play around with calling 
C from Go and seeing what the process is like
*/
